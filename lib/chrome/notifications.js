...
exports.notifications = exports.captcha = exports.alreadyWorking = exports.workerIdle = exports.notLoggedIn = undefined;
...
var alreadyWorking = exports.alreadyWorking = 'alreadyWorking';
...
}), _defineProperty(_deepFreeze, alreadyWorking, {
  iconUrl: _constants.CONFIG.chrome.notificationIconUrl,
  isClickable: false,
  type: 'basic',
  title: "You're already working",
  message: 'You can only do one job at a time. ' + "If you're finished, please wait for your previous job to be processed."
